...
def print_script(sequence1, structure1,
    ...
    if print_header:
        print ('// ==================== -*-Ruby-*- ====================\n'
               '//\n'
               '// MC-Sym 4.2 script generated by mcsymizer.py {version}\n'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-nd', '--no_dangling', action="store_true", dest="no_dangling",
    ...
    group.add_argument('-ph', '--print_header', action="store_false", 
                        dest="print_header",
                        help='Print the header in the script')
